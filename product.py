...
class productClass:
    def __init__(self,root):
        ...
        #===========column 2 ===============================
        cmb_cat=ttk.Combobox(product_frame,textvariable=self.var_cat,value=self.cat_list,state='readonly',justify=CENTER,font=("goudy old style",15))
        cmb_cat.place(x=150,y=60,width=200)
        cmb_cat.current(0)
        #==================================================
        cmb_sup=ttk.Combobox(product_frame,textvariable=self.var_sup,value=self.sup_list,state='readonly',justify=CENTER,font=("goudy old style",15))
        ...
        txt_status=Entry(product_frame,textvariable=self.var_qty,font=("goudy old style",15),bg="lightyellow").place(x=150,y=260,width=200)
        #==================================================
        cmb_status=ttk.Combobox(product_frame,textvariable=self.var_status,value=("Active","Inactive"),state='readonly',justify=CENTER,font=("goudy old style",15))
...
#==================datebase work========================
    ...
    def add(self):
        ...
        try:
            if self.var_cat.get()=="Select" or self.var_cat.get()=="Empty" or self.var_sup.get()=="Selct" or self.var_name.get()=="":
