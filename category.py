...
class categoryClass:
    def __init__(self,root):
        ...
        #===============category name label and entry field================
    ...
    def add(self):
        ...
        try:
            if self.var_name.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Category alrady present ,try diffrent",parent=self.root)
                else:
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get()=="":
                messagebox.showerror("Error","Please slect or enter category from the list",parent=self.root)   
            else:
